...
SIGNAL \encodedOut[0]~0_combout\ : std_logic;
...
\encodedOut[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \encodedOut[0]~0_combout\ = (\decodedIn[3]~input_o\) # ((\decodedIn[1]~input_o\ & !\decodedIn[2]~input_o\))
...
PORT MAP (
	...
	combout => \encodedOut[0]~0_combout\);

\Equal0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \Equal0~0_combout\ = (!\decodedIn[3]~input_o\ & !\decodedIn[2]~input_o\)
...
-- Equation(s):
-- \Equal0~1_combout\ = (!\decodedIn[3]~input_o\ & (!\decodedIn[1]~input_o\ & (!\decodedIn[2]~input_o\ & !\decodedIn[0]~input_o\)))
