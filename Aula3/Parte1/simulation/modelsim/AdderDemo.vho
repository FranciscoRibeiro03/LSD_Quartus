...
SIGNAL \inst|bit0|AxorB~combout\ : std_logic;
...
-- Equation(s):
-- \inst|bit1|cout~0_combout\ = (\SW[5]~input_o\ & ((\SW[1]~input_o\) # ((\SW[0]~input_o\ & \SW[4]~input_o\)))) # (!\SW[5]~input_o\ & (\SW[1]~input_o\ & (\SW[0]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \inst|bit3|cout~0_combout\ = (\inst|bit2|cout~0_combout\ & ((\SW[7]~input_o\) # (\SW[3]~input_o\))) # (!\inst|bit2|cout~0_combout\ & (\SW[7]~input_o\ & \SW[3]~input_o\))
...
-- Equation(s):
-- \inst|bit3|s~combout\ = \inst|bit2|cout~0_combout\ $ (\SW[7]~input_o\ $ (\SW[3]~input_o\))
...
-- Equation(s):
-- \inst|bit2|s~0_combout\ = \SW[6]~input_o\ $ (\inst|bit1|cout~0_combout\ $ (\SW[2]~input_o\))
...
\inst|bit0|AxorB\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|bit0|AxorB~combout\ = \SW[0]~input_o\ $ (\SW[4]~input_o\)
...
PORT MAP (
	datac => \SW[0]~input_o\,
	datad => \SW[4]~input_o\,
	combout => \inst|bit0|AxorB~combout\);
