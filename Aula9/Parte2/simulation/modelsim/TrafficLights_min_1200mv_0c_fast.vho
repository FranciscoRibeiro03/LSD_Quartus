...
SIGNAL \main_fsm|s_currentState.TYellowPerm~q\ : std_logic;
...
-- Equation(s):
-- \clk_div_1hz|Equal0~3_combout\ = (!\clk_div_1hz|s_divCounter\(9) & (!\clk_div_1hz|s_divCounter\(8) & (!\clk_div_1hz|s_divCounter\(10) & !\clk_div_1hz|s_divCounter\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \clk_div_1hz|s_divCounter\(9),
	datab => \clk_div_1hz|s_divCounter\(8),
...
-- Equation(s):
-- \clk_div_1hz|Equal0~11_combout\ = (\clk_div_1hz|Equal0~5_combout\ & (\clk_div_1hz|Equal0~10_combout\ & (\clk_div_1hz|Equal0~9_combout\ & \clk_div_1hz|Equal0~4_combout\)))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~6_combout\ = (\clk_div_1hz|Equal0~5_combout\ & (\clk_div_1hz|s_divCounter\(0) & (\clk_div_1hz|s_divCounter\(1) & \clk_div_1hz|Equal0~4_combout\)))
...
-- Equation(s):
-- \main_fsm|Selector5~0_combout\ = (\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TIntermit~q\ & (!\SW[0]~input_o\))) # (!\timer_fsm|s_cntZero~q\ & (((\main_fsm|s_currentState.TYellowPerm~q\))))
...
PORT MAP (
	...
	datab => \SW[0]~input_o\,
	datac => \main_fsm|s_currentState.TYellowPerm~q\,
	datad => \timer_fsm|s_cntZero~q\,
...
-- Location: FF_X107_Y56_N19
\main_fsm|s_currentState.TYellowPerm\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \main_fsm|s_currentState.TYellowPerm~q\);

-- Location: LCCOMB_X107_Y56_N10
\main_fsm|WideOr9\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|WideOr9~combout\ = (\main_fsm|s_currentState.TRed1~q\) # ((\main_fsm|s_currentState.TRed2~q\) # (\main_fsm|s_currentState.TYellowPerm~q\))
...
PORT MAP (
	...
	datac => \main_fsm|s_currentState.TRed2~q\,
	datad => \main_fsm|s_currentState.TYellowPerm~q\,
...
-- Equation(s):
-- \main_fsm|Selector4~1_combout\ = (\main_fsm|Selector4~0_combout\) # ((\SW[0]~input_o\ & (\timer_fsm|s_cntZero~q\ & \main_fsm|WideOr9~combout\)))
...
-- Equation(s):
-- \main_fsm|Selector6~0_combout\ = (\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TYellow1~q\) # ((!\SW[0]~input_o\ & \main_fsm|s_currentState.TYellowPerm~q\))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datab => \main_fsm|s_currentState.TYellowPerm~q\,
	datac => \main_fsm|s_currentState.TYellow1~q\,
	datad => \timer_fsm|s_cntZero~q\,
...
-- Equation(s):
-- \main_fsm|s_stateChanged~3_combout\ = ((\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TRed2~q\ $ (\main_fsm|s_currentState.TYellow2~q\)))) # (!\KEY[0]~input_o\)
...
-- Equation(s):
-- \main_fsm|s_stateChanged~2_combout\ = (\main_fsm|s_currentState.TYellowPerm~q\ & ((\main_fsm|s_currentState.TYellow1~q\ $ (\main_fsm|Selector7~0_combout\)) # (!\main_fsm|Selector5~0_combout\))) # (!\main_fsm|s_currentState.TYellowPerm~q\ & 
-- ((\main_fsm|Selector5~0_combout\) # (\main_fsm|s_currentState.TYellow1~q\ $ (\main_fsm|Selector7~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|s_currentState.TYellowPerm~q\,
...
-- Equation(s):
-- \main_fsm|s_stateChanged~4_combout\ = (\main_fsm|s_stateChanged~3_combout\) # (((\main_fsm|s_stateChanged~1_combout\) # (\main_fsm|s_stateChanged~2_combout\)) # (!\main_fsm|s_currentState.TInit~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|s_stateChanged~3_combout\,
	datab => \main_fsm|s_currentState.TInit~q\,
	datac => \main_fsm|s_stateChanged~1_combout\,
	datad => \main_fsm|s_stateChanged~2_combout\,
	combout => \main_fsm|s_stateChanged~4_combout\);

-- Location: LCCOMB_X105_Y56_N14
\main_fsm|s_stateChanged~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|s_stateChanged~5_combout\ = (!\main_fsm|s_stateChanged~0_combout\ & (!\main_fsm|s_stateChanged~4_combout\ & (\main_fsm|s_currentState.TIntermit~q\ $ (!\main_fsm|Selector4~1_combout\))))
...
PORT MAP (
	...
	datad => \main_fsm|s_stateChanged~4_combout\,
	combout => \main_fsm|s_stateChanged~5_combout\);

-- Location: FF_X105_Y56_N15
...
-- Equation(s):
-- \timer_fsm|Add1~27_combout\ = (!\main_fsm|s_stateChanged~q\ & (\main_fsm|WideOr9~combout\ $ (((\main_fsm|s_currentState.TYellow2~q\) # (\main_fsm|s_currentState.TYellow1~q\)))))
...
PORT MAP (
	dataa => \KEY[0]~input_o\,
	datab => \main_fsm|WideOr7~0_combout\,
	datac => \timer_fsm|Add1~2_combout\,
	datad => \main_fsm|s_stateChanged~q\,
	combout => \timer_fsm|Add1~4_combout\);

-- Location: LCCOMB_X107_Y56_N26
\timer_fsm|s_counter[1]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \timer_fsm|s_counter[1]~0_combout\ = (\KEY[0]~input_o\ & (\timer_fsm|s_counter\(0) & (\timer_fsm|s_counter\(1) & \timer_fsm|s_counter\(2))))
...
PORT MAP (
	...
	combout => \timer_fsm|s_counter[1]~0_combout\);
...
PORT MAP (
	...
	ena => \timer_fsm|s_counter[1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \timer_fsm|s_counter\(7));

-- Location: LCCOMB_X106_Y56_N24
\timer_fsm|s_counter[1]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \timer_fsm|s_counter[1]~1_combout\ = (((!\main_fsm|s_stateChanged~q\) # (!\timer_fsm|s_counter\(7))) # (!\timer_fsm|s_counter[1]~0_combout\)) # (!\timer_fsm|s_cntZero~1_combout\)
...
PORT MAP (
	...
	datab => \timer_fsm|s_counter[1]~0_combout\,
	datac => \timer_fsm|s_counter\(7),
	datad => \main_fsm|s_stateChanged~q\,
	combout => \timer_fsm|s_counter[1]~1_combout\);
...
-- Equation(s):
-- \timer_fsm|Add0~0_combout\ = (\main_fsm|s_currentState.TGreen2~q\ & (((\main_fsm|WideOr7~0_combout\ & \main_fsm|WideOr9~combout\)))) # (!\main_fsm|s_currentState.TGreen2~q\ & (!\main_fsm|s_currentState.TGreen1~q\))
...
-- Equation(s):
-- \timer_fsm|Add1~25_combout\ = (\KEY[0]~input_o\ & ((!\timer_fsm|Add1~16_combout\) # (!\main_fsm|s_stateChanged~q\)))
...
-- Equation(s):
-- \timer_fsm|s_cntZero~1_combout\ = (\timer_fsm|s_counter\(6) & (\timer_fsm|s_counter\(5) & (\timer_fsm|s_counter\(4) & \timer_fsm|s_counter\(3))))
...
-- Equation(s):
-- \LEDR~0_combout\ = (\main_fsm|s_currentState.TIntermit~q\ & (((\clk_div_1hz|clkOut~q\)))) # (!\main_fsm|s_currentState.TIntermit~q\ & ((\main_fsm|s_currentState.TYellowPerm~q\) # ((\main_fsm|s_currentState.TYellow2~q\))))
...
-- Equation(s):
-- \main_fsm|WideOr3~0_combout\ = (\main_fsm|s_currentState.TGreen1~q\) # ((\main_fsm|s_currentState.TYellow1~q\) # ((\main_fsm|s_currentState.TRed2~q\) # (\main_fsm|s_currentState.TRed1~q\)))
...
-- Equation(s):
-- \main_fsm|WideOr1~0_combout\ = (\main_fsm|s_currentState.TGreen2~q\) # ((\main_fsm|s_currentState.TRed2~q\) # ((\main_fsm|s_currentState.TYellow2~q\) # (\main_fsm|s_currentState.TRed1~q\)))
...
-- Equation(s):
-- \LEDR~1_combout\ = (\main_fsm|s_currentState.TIntermit~q\ & (((\clk_div_1hz|clkOut~q\)))) # (!\main_fsm|s_currentState.TIntermit~q\ & ((\main_fsm|s_currentState.TYellow1~q\) # ((\main_fsm|s_currentState.TYellowPerm~q\))))
