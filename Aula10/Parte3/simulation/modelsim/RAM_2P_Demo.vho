...
SIGNAL \inst3|s_pulsedOut~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \inst4|s_cntVal[0]~0_combout\ : std_logic;
SIGNAL \inst4|Add0~2_combout\ : std_logic;
SIGNAL \inst4|s_cntVal[1]~feeder_combout\ : std_logic;
SIGNAL \inst4|Add0~1_combout\ : std_logic;
SIGNAL \inst4|s_cntVal[2]~feeder_combout\ : std_logic;
SIGNAL \inst4|Add0~0_combout\ : std_logic;
SIGNAL \inst4|s_cntVal[3]~feeder_combout\ : std_logic;
...
SIGNAL \inst3|s_debounceCnt[22]~2_combout\ : std_logic;
SIGNAL \inst3|s_debounceCnt[22]~3_combout\ : std_logic;
...
SIGNAL \inst3|s_debounceCnt[22]~0_combout\ : std_logic;
...
SIGNAL \inst3|s_pulsedOut~clkctrl_outclk\ : std_logic;
SIGNAL \SW[0]~input_o\ : std_logic;
SIGNAL \SW[8]~input_o\ : std_logic;
SIGNAL \SW[9]~input_o\ : std_logic;
SIGNAL \SW[10]~input_o\ : std_logic;
SIGNAL \SW[11]~input_o\ : std_logic;
SIGNAL \inst4|s_cntVal[0]~_wirecell_combout\ : std_logic;
...
SIGNAL \inst4|s_cntVal\ : std_logic_vector(3 DOWNTO 0);
...
\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTADATAIN_bus\ <= (gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & \SW[7]~input_o\
& \SW[6]~input_o\ & \SW[5]~input_o\ & \SW[4]~input_o\ & \SW[3]~input_o\ & \SW[2]~input_o\ & \SW[1]~input_o\ & \SW[0]~input_o\);

\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\SW[11]~input_o\ & \SW[10]~input_o\ & \SW[9]~input_o\ & \SW[8]~input_o\);

\inst|s_memory_rtl_0|auto_generated|ram_block1a0_PORTBADDR_bus\ <= (\inst4|Add0~0_combout\ & \inst4|Add0~1_combout\ & \inst4|Add0~2_combout\ & \inst4|s_cntVal[0]~_wirecell_combout\);
...
\inst3|s_pulsedOut~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \inst3|s_pulsedOut~q\);
...
-- Equation(s):
-- \inst2|LessThan0~1_combout\ = (((!\inst2|s_divCounter\(15)) # (!\inst2|s_divCounter\(13))) # (!\inst2|s_divCounter\(14))) # (!\inst2|s_divCounter\(12))
...
-- Equation(s):
-- \inst2|LessThan0~2_combout\ = (\inst2|LessThan1~4_combout\ & (!\inst2|s_divCounter\(11) & ((\inst2|LessThan1~3_combout\) # (!\inst2|s_divCounter\(6)))))
...
-- Equation(s):
-- \inst2|LessThan1~1_combout\ = (((!\inst2|s_divCounter\(11)) # (!\inst2|s_divCounter\(13))) # (!\inst2|s_divCounter\(14))) # (!\inst2|s_divCounter\(12))
...
-- Equation(s):
-- \inst2|LessThan1~7_combout\ = (\inst2|LessThan1~0_combout\ & (\inst2|s_divCounter\(18) & ((\inst2|LessThan1~6_combout\) # (\inst2|s_divCounter\(17)))))
...
PORT MAP (
	...
	datab => \inst2|LessThan1~6_combout\,
	datac => \inst2|s_divCounter\(18),
	datad => \inst2|s_divCounter\(17),
...
-- Equation(s):
-- \inst2|LessThan1~8_combout\ = (\inst2|s_divCounter\(25)) # ((\inst2|s_divCounter\(24) & ((\inst2|LessThan1~7_combout\) # (\inst2|s_divCounter\(23)))))
...
\inst4|s_cntVal[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_cntVal[0]~0_combout\ = !\inst4|s_cntVal\(0)
...
-- pragma translate_on
PORT MAP (
	datac => \inst4|s_cntVal\(0),
	combout => \inst4|s_cntVal[0]~0_combout\);

-- Location: FF_X105_Y62_N27
\inst4|s_cntVal[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \inst4|Add0~2_combout\ = \inst4|s_cntVal\(0) $ (\inst4|s_cntVal\(1))
...
PORT MAP (
	datac => \inst4|s_cntVal\(0),
	datad => \inst4|s_cntVal\(1),
	combout => \inst4|Add0~2_combout\);

-- Location: LCCOMB_X105_Y62_N28
\inst4|s_cntVal[1]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_cntVal[1]~feeder_combout\ = \inst4|Add0~2_combout\
...
PORT MAP (
	...
	combout => \inst4|s_cntVal[1]~feeder_combout\);

-- Location: FF_X105_Y62_N29
\inst4|s_cntVal[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	d => \inst4|s_cntVal[1]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst4|s_cntVal\(1));
...
-- Equation(s):
-- \inst4|Add0~1_combout\ = \inst4|s_cntVal\(2) $ (((\inst4|s_cntVal\(0) & \inst4|s_cntVal\(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|s_cntVal\(0),
	datac => \inst4|s_cntVal\(2),
	datad => \inst4|s_cntVal\(1),
	combout => \inst4|Add0~1_combout\);

-- Location: LCCOMB_X105_Y62_N30
\inst4|s_cntVal[2]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_cntVal[2]~feeder_combout\ = \inst4|Add0~1_combout\
...
PORT MAP (
	...
	combout => \inst4|s_cntVal[2]~feeder_combout\);

-- Location: FF_X105_Y62_N31
\inst4|s_cntVal[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	d => \inst4|s_cntVal[2]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst4|s_cntVal\(2));
...
-- Equation(s):
-- \inst4|Add0~0_combout\ = \inst4|s_cntVal\(3) $ (((\inst4|s_cntVal\(2) & (\inst4|s_cntVal\(0) & \inst4|s_cntVal\(1)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|s_cntVal\(2),
	datab => \inst4|s_cntVal\(3),
	datac => \inst4|s_cntVal\(0),
	datad => \inst4|s_cntVal\(1),
	combout => \inst4|Add0~0_combout\);

-- Location: LCCOMB_X105_Y62_N24
\inst4|s_cntVal[3]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_cntVal[3]~feeder_combout\ = \inst4|Add0~0_combout\
...
PORT MAP (
	...
	combout => \inst4|s_cntVal[3]~feeder_combout\);

-- Location: FF_X105_Y62_N25
\inst4|s_cntVal[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	d => \inst4|s_cntVal[3]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst4|s_cntVal\(3));
...
-- Equation(s):
-- \inst3|s_debounceCnt~27_combout\ = (\inst3|Add0~10_combout\ & (\inst3|s_previousIn~q\ & \inst3|s_debounceCnt[22]~0_combout\))
...
PORT MAP (
	...
	datad => \inst3|s_debounceCnt[22]~0_combout\,
...
PORT MAP (
	...
	ena => \inst3|s_debounceCnt[22]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst3|s_debounceCnt~1_combout\ = (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~12_combout\) # (!\inst3|s_previousIn~q\)))
...
-- Equation(s):
-- \inst3|s_debounceCnt~11_combout\ = (\inst3|Add0~14_combout\ & (\inst3|s_previousIn~q\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~12_combout\ = (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~16_combout\) # (!\inst3|s_previousIn~q\)))
...
-- Equation(s):
-- \inst3|s_debounceCnt~13_combout\ = (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~18_combout\) # (!\inst3|s_previousIn~q\)))
...
-- Equation(s):
-- \inst3|s_debounceCnt~14_combout\ = (\inst3|Add0~20_combout\ & (\inst3|s_previousIn~q\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_pulsedOut~2_combout\ = (!\inst3|s_debounceCnt\(9) & (!\inst3|s_debounceCnt\(10) & (!\inst3|s_debounceCnt\(7) & !\inst3|s_debounceCnt\(8))))
...
-- Equation(s):
-- \inst3|s_debounceCnt~15_combout\ = (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~22_combout\) # (!\inst3|s_previousIn~q\)))
...
PORT MAP (
	dataa => \inst3|s_previousIn~q\,
	datac => \inst3|s_debounceCnt[22]~0_combout\,
...
-- Equation(s):
-- \inst3|s_debounceCnt~7_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~24_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~8_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~26_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~16_combout\ = (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~28_combout\) # (!\inst3|s_previousIn~q\)))
...
-- Equation(s):
-- \inst3|s_debounceCnt~4_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~30_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~5_combout\ = (\inst3|s_previousIn~q\ & (\inst3|s_debounceCnt[22]~0_combout\ & \inst3|Add0~32_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~6_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~34_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt[18]~17_combout\ = (\inst3|s_debounceCnt[22]~3_combout\ & (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~36_combout\) # (!\inst3|s_previousIn~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|s_debounceCnt[22]~3_combout\,
	datab => \inst3|s_previousIn~q\,
...
-- Equation(s):
-- \inst3|s_debounceCnt[19]~18_combout\ = (\inst3|s_debounceCnt[22]~3_combout\ & (\inst3|s_debounceCnt[22]~0_combout\ & ((\inst3|Add0~38_combout\) # (!\inst3|s_previousIn~q\))))
...
-- Equation(s):
-- \inst3|s_debounceCnt[20]~9_combout\ = (\inst3|s_debounceCnt[22]~3_combout\ & (\inst3|s_previousIn~q\ & (\inst3|s_debounceCnt[22]~0_combout\ & \inst3|Add0~40_combout\)))
...
-- Equation(s):
-- \inst3|s_pulsedOut~1_combout\ = (!\inst3|s_debounceCnt\(13) & (!\inst3|s_debounceCnt\(12) & (!\inst3|s_debounceCnt\(21) & !\inst3|s_debounceCnt\(20))))
...
-- Equation(s):
-- \inst3|s_pulsedOut~3_combout\ = (!\inst3|s_debounceCnt\(19) & (!\inst3|s_debounceCnt\(11) & (!\inst3|s_debounceCnt\(18) & !\inst3|s_debounceCnt\(14))))
...
-- Equation(s):
-- \inst3|s_pulsedOut~0_combout\ = (!\inst3|s_debounceCnt\(6) & (!\inst3|s_debounceCnt\(16) & (!\inst3|s_debounceCnt\(17) & !\inst3|s_debounceCnt\(15))))
...
-- Equation(s):
-- \inst3|s_pulsedOut~4_combout\ = (\inst3|s_pulsedOut~2_combout\ & (\inst3|s_pulsedOut~1_combout\ & (\inst3|s_pulsedOut~3_combout\ & \inst3|s_pulsedOut~0_combout\)))
...
PORT MAP (
	...
	datab => \inst3|s_pulsedOut~1_combout\,
...
\inst3|s_debounceCnt[22]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_debounceCnt[22]~2_combout\ = (\inst3|s_debounceCnt\(0)) # ((\inst3|s_debounceCnt\(5)) # ((!\inst3|s_pulsedOut~4_combout\) # (!\inst3|s_pulsedOut~5_combout\)))
...
PORT MAP (
	...
	combout => \inst3|s_debounceCnt[22]~2_combout\);

-- Location: LCCOMB_X109_Y41_N30
\inst3|s_debounceCnt[22]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_debounceCnt[22]~3_combout\ = (((\inst3|s_debounceCnt\(22)) # (\inst3|s_debounceCnt[22]~2_combout\)) # (!\inst3|s_dirtyIn~q\)) # (!\inst3|s_previousIn~q\)
...
PORT MAP (
	...
	datad => \inst3|s_debounceCnt[22]~2_combout\,
	combout => \inst3|s_debounceCnt[22]~3_combout\);
...
-- Equation(s):
-- \inst3|s_debounceCnt[21]~10_combout\ = (\inst3|s_debounceCnt[22]~3_combout\ & (\inst3|s_previousIn~q\ & (\inst3|s_debounceCnt[22]~0_combout\ & \inst3|Add0~42_combout\)))
...
-- Equation(s):
-- \inst3|LessThan0~0_combout\ = (!\inst3|s_debounceCnt\(21) & !\inst3|s_debounceCnt\(20))
...
-- Equation(s):
-- \inst3|LessThan0~4_combout\ = (\inst3|s_debounceCnt\(19) & (\inst3|s_debounceCnt\(18) & (\inst3|s_debounceCnt\(8) & \inst3|s_debounceCnt\(14))))
...
-- Equation(s):
-- \inst3|LessThan0~5_combout\ = (\inst3|s_debounceCnt\(9) & (\inst3|s_debounceCnt\(11) & \inst3|LessThan0~4_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt[22]~24_combout\ = (\inst3|s_debounceCnt\(22) & (\inst3|LessThan0~0_combout\ & (!\inst3|LessThan0~7_combout\))) # (!\inst3|s_debounceCnt\(22) & (((\inst3|s_debounceCnt[22]~2_combout\))))
...
-- Equation(s):
-- \inst3|s_debounceCnt[22]~25_combout\ = (\inst3|s_previousIn~q\ & (\inst3|s_dirtyIn~q\)) # (!\inst3|s_previousIn~q\ & ((\inst3|s_debounceCnt[22]~0_combout\)))
...
-- Equation(s):
-- \inst3|s_debounceCnt[22]~26_combout\ = (\inst3|s_debounceCnt[22]~25_combout\ & (((\inst3|Add0~44_combout\ & \inst3|s_debounceCnt[22]~24_combout\)) # (!\inst3|s_previousIn~q\)))
...
PORT MAP (
	...
	datac => \inst3|s_debounceCnt[22]~24_combout\,
	datad => \inst3|s_debounceCnt[22]~25_combout\,
...
\inst3|s_debounceCnt[22]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_debounceCnt[22]~0_combout\ = (\inst3|s_dirtyIn~q\ & (((\inst3|LessThan0~0_combout\ & !\inst3|LessThan0~7_combout\)) # (!\inst3|s_debounceCnt\(22))))
...
PORT MAP (
	...
	combout => \inst3|s_debounceCnt[22]~0_combout\);

-- Location: LCCOMB_X108_Y41_N2
\inst3|s_debounceCnt~23\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_debounceCnt~23_combout\ = (\inst3|Add0~0_combout\ & (\inst3|s_previousIn~q\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~19_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~2_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~20_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~4_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~21_combout\ = (\inst3|Add0~6_combout\ & (\inst3|s_previousIn~q\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_debounceCnt~22_combout\ = (\inst3|s_previousIn~q\ & (\inst3|Add0~8_combout\ & \inst3|s_debounceCnt[22]~0_combout\))
...
-- Equation(s):
-- \inst3|s_pulsedOut~5_combout\ = (!\inst3|s_debounceCnt\(4) & (!\inst3|s_debounceCnt\(2) & (!\inst3|s_debounceCnt\(3) & !\inst3|s_debounceCnt\(1))))
...
-- Equation(s):
-- \inst3|s_pulsedOut~6_combout\ = (!\inst3|s_debounceCnt\(22) & (\inst3|s_debounceCnt\(0) & (\inst3|s_previousIn~q\ & \inst3|s_dirtyIn~q\)))
...
-- Location: CLKCTRL_G5
\inst3|s_pulsedOut~clkctrl\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \inst3|s_pulsedOut~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \inst3|s_pulsedOut~clkctrl_outclk\);
...
\inst4|s_cntVal[0]~_wirecell\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst4|s_cntVal[0]~_wirecell_combout\ = !\inst4|s_cntVal\(0)
...
-- pragma translate_on
PORT MAP (
	datad => \inst4|s_cntVal\(0),
	combout => \inst4|s_cntVal[0]~_wirecell_combout\);
...
PORT MAP (
	...
	portbre => VCC,
	clk0 => \inst3|s_pulsedOut~clkctrl_outclk\,
