...
SIGNAL ww_SW : std_logic_vector(0 TO 7);
...
-- Equation(s):
-- \inst|s_count[0]~10_combout\ = (!\SW[1]~input_o\ & ((\SW[3]~input_o\ & (\SW[7]~input_o\)) # (!\SW[3]~input_o\ & ((!\inst|s_count\(0))))))
...
-- Equation(s):
-- \inst|s_count[0]~11_combout\ = (\SW[2]~input_o\ & (((\inst|s_count[0]~10_combout\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & ((\inst|s_count[0]~10_combout\))) # (!\SW[1]~input_o\ & (\inst|s_count\(0)))))
...
-- Equation(s):
-- \inst|s_count[3]~9_combout\ = (\SW[1]~input_o\) # (\SW[2]~input_o\)
...
-- Equation(s):
-- \inst|s_count[3]~12_combout\ = \inst|s_count\(3) $ (\inst|s_count[2]~8\ $ (\SW[0]~input_o\))
...
-- Equation(s):
-- \inst1|decOut_n~0_combout\ = (\inst|s_count\(0) & (!\inst|s_count\(3) & (\inst|s_count\(2) $ (!\inst|s_count\(1))))) # (!\inst|s_count\(0) & (!\inst|s_count\(1) & (\inst|s_count\(2) $ (!\inst|s_count\(3)))))
...
-- Equation(s):
-- \inst1|decOut_n~1_combout\ = (\inst|s_count\(0) & (\inst|s_count\(3) $ (((\inst|s_count\(1)) # (!\inst|s_count\(2)))))) # (!\inst|s_count\(0) & (!\inst|s_count\(2) & (\inst|s_count\(1) & !\inst|s_count\(3))))
...
-- Equation(s):
-- \inst1|decOut_n~2_combout\ = (\inst|s_count\(1) & (\inst|s_count\(0) & ((!\inst|s_count\(3))))) # (!\inst|s_count\(1) & ((\inst|s_count\(2) & ((!\inst|s_count\(3)))) # (!\inst|s_count\(2) & (\inst|s_count\(0)))))
...
-- Equation(s):
-- \inst1|decOut_n~3_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(0) & (\inst|s_count\(2))) # (!\inst|s_count\(0) & (!\inst|s_count\(2) & \inst|s_count\(3))))) # (!\inst|s_count\(1) & (!\inst|s_count\(3) & (\inst|s_count\(0) $ (\inst|s_count\(2)))))
...
-- Equation(s):
-- \inst1|decOut_n~4_combout\ = (\inst|s_count\(2) & (\inst|s_count\(3) & ((\inst|s_count\(1)) # (!\inst|s_count\(0))))) # (!\inst|s_count\(2) & (!\inst|s_count\(0) & (\inst|s_count\(1) & !\inst|s_count\(3))))
...
-- Equation(s):
-- \inst1|decOut_n~5_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(0) & ((\inst|s_count\(3)))) # (!\inst|s_count\(0) & (\inst|s_count\(2))))) # (!\inst|s_count\(1) & (\inst|s_count\(2) & (\inst|s_count\(0) $ (\inst|s_count\(3)))))
...
-- Equation(s):
-- \inst1|decOut_n~6_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(1) & (\inst|s_count\(0) $ (!\inst|s_count\(3))))) # (!\inst|s_count\(2) & (\inst|s_count\(0) & (\inst|s_count\(1) $ (!\inst|s_count\(3)))))
